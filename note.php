    ...
    <div class="nk-main">
        ...
        <div class="container">
            <ul class="nk-breadcrumbs">
                ...
                <li><span>Let's Learn About Animal!</span></li>
            ...
            <div class="row vertical-gap">
                ...
                <div class="col-md-12">
                    <div class="nk-feature-cont text-right">
                        <a href="note.php" class="nk-btn nk-btn-x4 nk-btn-rounded nk-btn-color-primary nk-btn-hover-color-info">
    ...
    <script>
        ...
        function speak(insectname) {
            ...
            recognition.onresult = function(event) {
                ...
                console.log("speak - " + transcript.toLowerCase());
                console.log("insek - " + insectname.toLowerCase());


                //if( transcript.toLowerCase() ==  insectname.toLowerCase()){
                if( transcript.includes(insectname)){
                    $('#modalpopup').click();
                    console.log("same");
                }else{
                    $('#errormodal').click();
